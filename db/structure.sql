...
CREATE  TABLE IF NOT EXISTS `arsip` (
  ...
  `arsip_number` VARCHAR(100) NULL ,
  `arsip_generate` VARCHAR(100) NULL ,
  `arsip_date` DATE NULL ,
  `arsip_image` VARCHAR(255) NULL ,
  `category_category_id` INT NULL ,
  `user_user_id` INT NULL ,
  `arsip_input_date` TIMESTAMP NULL ,
  `arsip_last_update` TIMESTAMP NULL ,
  PRIMARY KEY (`arsip_id`) ,
  INDEX `fk_arsip_category1_idx` (`category_category_id` ASC) ,
  CONSTRAINT `fk_arsip_category1`
