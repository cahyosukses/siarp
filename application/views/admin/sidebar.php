...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    ...
    <div class="menu_section">
        <ul class="nav side-menu">
            ...
            <li><a><i class="fa fa-users"></i> Arsip <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu" style="display: none">
                    <li><a href="<?php echo site_url('admin/arsip') ?>">List Arsip</a>
                    <li><a href="<?php echo site_url('admin/category') ?>">Kategori</a>
                    </li>
                </ul>
            </li>            
